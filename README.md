...
![alt tag](https://github.com/abdul9255/Secret-Key-Encryption-Lab/blob/main/1a.PNG) 

  ```tr [:upper:] [:lower:] < article.txt > lowercase.txt
  tr -cd ’[a-z][\n][:space:]’ < lowercase.txt > plaintext.txt```

![alt tag](https://github.com/abdul9255/Secret-Key-Encryption-Lab/blob/main/1b.PNG) 
...
![alt tag](https://github.com/abdul9255/Secret-Key-Encryption-Lab/blob/main/1c.PNG) 
...
![alt tag](https://github.com/abdul9255/Secret-Key-Encryption-Lab/blob/main/1d.PNG)
...
![alt tag](https://github.com/abdul9255/Secret-Key-Encryption-Lab/blob/main/2a.PNG)
...
![alt tag](https://github.com/abdul9255/Secret-Key-Encryption-Lab/blob/main/2b.PNG)
...
![alt tag](https://github.com/abdul9255/Secret-Key-Encryption-Lab/blob/main/2c.PNG)
...
![alt tag](https://github.com/abdul9255/Secret-Key-Encryption-Lab/blob/main/3a.PNG)
...
-K 00112233445566778889aabbccddeeff
ls -ld ecb_out.bin 
![alt tag](https://github.com/abdul9255/Secret-Key-Encryption-Lab/blob/main/4a.PNG)
...
![alt tag](https://github.com/abdul9255/Secret-Key-Encryption-Lab/blob/main/4b.PNG)          
...
-iv 0102030405060708
ls -ld cfb_out.bin #5
![alt tag](https://github.com/abdul9255/Secret-Key-Encryption-Lab/blob/main/4c.PNG)
...
![alt tag](https://github.com/abdul9255/Secret-Key-Encryption-Lab/blob/main/4d.PNG)
...
![alt tag](https://github.com/abdul9255/Secret-Key-Encryption-Lab/blob/main/4e.PNG)

openssl enc  -aes-128-ecb  -e -in big_file.txt -out big_out.bin \
-K 00112233445566778889aabbccddeeff 

![alt tag](https://github.com/abdul9255/Secret-Key-Encryption-Lab/blob/main/4f.PNG)

openssl enc  -aes-128-ecb  -d -in big_out.bin -out decrypted.txt \
-K 00112233445566778889aabbccddeeff 

![alt tag](https://github.com/abdul9255/Secret-Key-Encryption-Lab/blob/main/5a.PNG)
